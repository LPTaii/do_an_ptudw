    ...
    <div id="appWrapper" ref="wrapper">
        ...
        <nav-navbar>
          <div class="user-menu" v-if="($route.meta.userType === 'CUSTOMER') && currentUserC">
            <div class="menu-label">
              <img class="user-avatar" :src="origin + '/bill.jpg'" alt="" @click="$router.push({ name: 'CustomerOrdersList' })"  v-if="$route.meta.userType === 'CUSTOMER'">
              <router-link class="user-text" :to="{ name: 'CustomerOrdersList' }"
                v-if="$route.meta.userType === 'CUSTOMER'">Đơn hàng</router-link>
            </div>
          </div>
          ...
          <div class="user-menu" v-if="$route.meta.userType === 'CUSTOMER'">
            <div class="menu-label">
              ...
              <a href="#" class="user-text" v-if="!currentUserC">Tài khoản</a>
              <a href="#" class="user-text" v-else>{{ currentUserC.name }}</a>
            </div>
            <ul class="menu-select" v-if="!currentUserC">
              <li>
                <router-link :to="{ name: 'CustomerSignin' }">Đăng nhập</router-link>
              </li>
              <li>
                <router-link :to="{ name: 'CustomerSignup' }">Đăng ký</router-link>
              </li>
            </ul>
          ...
          <div class="user-menu" v-if="$route.meta.userType === 'ADMIN'">
            <div class="menu-label">
              ...
              <a href="#" class="user-text" v-if="!currentUserE">Tài khoản</a>
              <a href="#" class="user-text" v-else>{{ currentUserE.name }}</a>
            </div>
            <ul class="menu-select" v-if="!currentUserE">
              <li>
                <router-link :to="{ name: 'AdminSignin' }">Đăng nhập</router-link>
              </li>
              <li>
                <router-link :to="{ name: 'AdminSignup' }">Đăng ký</router-link>
              </li>
            </ul>
            <ul class="menu-select" v-else>
      ...
      <div id="body">
        ...
        <div id="content" ref="content">
          <Suspense>
            <RouterView  @updateAuthentication="updateAuthentication"
